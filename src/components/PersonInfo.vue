<template>
  <form class="col-md-8 mt-5 px-4 py-3 bg-light" style="border-radius:4px;max-width:600px">
    ...
    <div class="row justify-content-around">
      <button @click.prevent="submit" class="btn col-md-3 btn-success">提交</button>
      <button @click.prevent="cancel" class="btn col-md-3 btn-danger">取消</button>
    </div>
  </form>
</template>
<script>
